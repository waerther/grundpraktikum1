...
Es fällt auf, dass die mechanische Leistung negativ ist. Dies rührt von dem negativen Massendurchsatz wie der Tabelle (\ref{tb:massendurchsaetze}) entnommen werden kann. 
