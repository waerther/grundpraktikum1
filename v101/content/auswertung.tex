...
Diese ist ebenfalls in Abbildung (\ref{fig:rechterWinkel}) zu sehen.
...
\begin{equation*}
  \stackrel{(\ref{eq:Tumgestellt}),(\ref{fehler:gauß})}{\implies} I_E = (0.39985 \pm ) \cdot 10^{-3} 
