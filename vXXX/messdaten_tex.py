...
messdaten = pd.read_csv("Messdaten_tex.csv", sep=';', index_col=0)
#tabelle = pd.DataFrame(messdaten)
# i = 1
# while i < len(messdaten.columns)+1: 
#     messdaten.insert(i, " ", "&")
#     i += 2 
#messdaten.head()
print(messdaten)

#       &  t^2(s^2) &.1 T_1 (C) &.2 T_2 (C)  &.3 T_1 (K) &.4 T_2 (K) &.5 p_a (bar) &.6 p_b (bar) &.7  p_a+ (Pa) &.8   p_b+ (Pa) &.9   P (W) &.10 1/T_1 (1/K)
# t(s)
# 0     &         0   &   21,50   &    21,50   &  294,65   &  294,65   &      4,20   &      3,80   &  520000,00   &   480000,00   &    leer    &      0,0034
# 60    &      3600   &   23,30   &    20,70   &  296,45   &  293,85   &      3,90   &      5,30   &  490000,00   &   630000,00   &    leer    &      0,0034
# 120   &     14400   &   24,70   &    19,30   &  297,85   &  292,45   &      3,60   &      5,90   &  460000,00   &   690000,00   &    leer    &      0,0034
# 180   &     32400   &   26,40   &    17,70   &  299,55   &  290,85   &      3,60   &      6,00   &  460000,00   &   700000,00   &    leer    &      0,0033
# 240   &     57600   &   27,90   &    16,60   &  301,05   &  289,75   &      3,60   &      6,40   &  460000,00   &   740000,00   &    leer    &      0,0033
